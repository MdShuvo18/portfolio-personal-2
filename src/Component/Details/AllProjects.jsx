                ...
                <div className="hero bg-black min-h-screen">
                    <div className="hero-content flex-col lg:flex-row gap-24">
                        <img
                            ...
                            className="max-w-sm rounded-lg shadow-2xl" />
                        <div className="text-white space-y-6">
                            <h1 className="text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-violet-500 to-fuchsia-500">PulsePost #2</h1>
                            <p className="py-6 text-lg">
                ...
                <div className="hero bg-black min-h-screen">
                    <div className="hero-content flex-col lg:flex-row-reverse">
                        <img
                            ...
                            className="max-w-sm rounded-lg shadow-2xl" />
                        <div className="text-white space-y-6">
                            <h1 className="text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-violet-500 to-fuchsia-500">ArtyPot #3</h1>
                            <p className="py-6 text-lg">
