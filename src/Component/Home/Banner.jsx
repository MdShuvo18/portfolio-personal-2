...
const Banner = () => {
    return (
        <div className="grid grid-cols-1 justify-items-center text-center space-y-10">
            ...
            <p className="animate__animated animate__flipInX animate__delay-1s text-[#C5C5C5] font-semibold text-lg"> I am a skilled web developer specializing in front-end development with a passion for creating dynamic, responsive web applications. Proficient in <span className="text-2xl font-bold bg-clip-text text-transparent bg-primary-gradient">HTML</span>, <span className="text-2xl font-bold bg-clip-text text-transparent bg-primary-gradient">CSS</span>, <span className="text-2xl font-bold bg-clip-text text-transparent bg-primary-gradient">JavaScript</span>, and modern frameworks like <span className="text-2xl font-bold bg-clip-text text-transparent bg-primary-gradient">Tailwind</span> , <span className="text-2xl font-bold bg-clip-text text-transparent bg-primary-gradient">React</span> and <span className="text-2xl font-bold bg-clip-text text-transparent bg-primary-gradient">Redux-Toolkit</span>, I build intuitive user interfaces. My expertise extends to backend development with <span className="text-2xl font-bold bg-clip-text text-transparent bg-primary-gradient">MongoDB</span> and <span className="text-2xl font-bold bg-clip-text text-transparent bg-primary-gradient">Node.js</span>, enabling me to deliver seamless full-stack solutions. Committed to excellence and continuous learning, I stay updated with the latest industry trends to ensure my projects are cutting-edge and future-proof.</p>
            <div>
